            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="inicio.php"><i class="menu-icon fa fa-laptop"></i>Home </a>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-area-chart"></i>Configuracion</a>
                            <ul class="sub-menu children dropdown-menu">
                ...
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div >
                                <div class="">
                                    <div id="" class="float-chart ml-4 mr-4"></div>
                                </div>
                                <div id="" class="float-chart"></div>
                            </div><!-- /.card -->
                        </div>
