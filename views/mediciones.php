                    ...
                    <div class="col-xs-4 col-sm-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Registrar Mision</strong>
                            </div>
                            <div class="card-body">
                            <form id="F_mediciones" autocomplete="off">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="Codigo mision" class="form-control" id="Nombre_sensor"  required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="put" name="Rango" class="form-control"   required>
                                            </div>
                                        </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label" for="Precision sensor">Usuario</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-tachometer" style="color: #03a9f3" aria-hidden="true"></i>
                                                </div>
                                                <input readonly class="form-control" id="Precision" name="Precision" type="text" value=" <?php echo $_SESSION["user"]["USUARIO"];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="Correo">Estado mision</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                ...
                                <button type="button" class="btn btn-danger" id="bt-registrarSensor" onclick="Registrar_Sensor();">Pausar</button>
                                <button type="button" class="btn btn-success" id="bt-registrarSensor" onclick="Registrar_Sensor();">Finalizar</button>
                            </div>
                        </div>
